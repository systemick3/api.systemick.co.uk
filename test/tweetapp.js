...
describe('tweets', function () {
  ...
  it('retrieves a tweet', function (done) {
    superagent.get(baseUrl + '/tweetapp/auth/tweet/one/664100884679368705')
      .end(function (e, res) {
        expect(e).to.eql(null);
        expect(res.status).to.eql(200);
        expect(typeof res.body).to.eql('object');
        expect(res.body.id_str).to.eql('664100884679368705');
        done();
      });
  });
  ...
  /*it('gets a list of retweets', function (done) {
    superagent.get(baseUrl + '/tweetapp/auth/tweet/retweeters/579625134186766338')
      .end(function (e, res) {
        expect(e).to.eql(null);
        expect(res.status).to.eql(200);
        expect(res.body.msg).to.eql('success');
